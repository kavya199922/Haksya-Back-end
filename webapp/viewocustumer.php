...
<?php
 include "connect.php";
       if(isset($_POST['view'])){
        ...
        $sqlSelect = "SELECT * FROM login WHERE USERTYPE='onlinecustomer' ";
...
<!--                view searched detail -->
    ...
    <form method="POST" action="viewanddeleteonlinecust.php">
    ...
    if(isset($_POST['deleteall'])){
        mysqli_query($conn,"DELETE FROM login WHERE USERTYPE='onlinecustomer'");
