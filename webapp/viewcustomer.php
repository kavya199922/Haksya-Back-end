...
<body>
    ...
    <div id="search">
            <center>
    <form  method="POST">
        <input name="custName" type="search" placeholder="customerName" width="200" height="200">
...
<!--                view searched detail -->
    ...
    if(isset($_POST['search-btn'])){
        include "connect.php";
    $search=$_POST['custName'];
    $sql="SELECT * FROM shop  WHERE CUSTOMERNAME LIKE '%$search%'";
    ...
    <form method="POST" action="viewanddeletecustomer.php">
