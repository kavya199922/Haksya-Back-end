...
<?php
 include "connect.php";
       if(isset($_POST['view'])){
        ...
        $sqlSelect = "SELECT * FROM login WHERE USERTYPE='admin' ";
...
<!--                SEARCH RESULT -->
    ...
    <form method="POST" action="viewanddeleteadmin.php">
    ...
    if(isset($_POST['deleteall'])){
        mysqli_query($conn,"DELETE FROM login WHERE USERTYPE='admin'");
